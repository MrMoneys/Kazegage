...
function Library:Window(p)
	...
	do
		...
		do
			...
			-- Configuração de tamanho personalizado
local closeUISize = CloseUI.Size or {70, 40}
CloseUIShadow.Size = UDim2.new(0, closeUISize[1], 0, closeUISize[2])
			...
			-- Frame para organizar ícone e texto
local ContentFrame = Instance.new("Frame")
ContentFrame.Name = "ContentFrame"
ContentFrame.Parent = BackgroundCloseUI_1
...
-- Ícone (se fornecido)
if CloseUI.Icon and CloseUI.Icon ~= "" then
	...
	Icon.Image = gl(CloseUI.Icon).Image
	Icon.ImageRectSize = gl(CloseUI.Icon).ImageRectSize
	Icon.ImageRectOffset = gl(CloseUI.Icon).ImageRectPosition
...
-- Texto
Title_1.Name = "Title"
Title_1.Parent = ContentFrame
Title_1.AutomaticSize = Enum.AutomaticSize.XY
Title_1.BackgroundColor3 = Color3.fromRGB(255,255,255)
Title_1.BackgroundTransparency = 1
Title_1.BorderColor3 = Color3.fromRGB(0,0,0)
Title_1.BorderSizePixel = 0
Title_1.Size = UDim2.new(0, 0,0, 0)
Title_1.Font = Enum.Font.GothamBold
...
addToTheme('Text & Icon', Title_1)
			...
			-- Atualiza após renderizar
-- Espera um frame para calcular o tamanho correto
-- Atualiza após renderizar
task.defer(function()
    if not CloseUI.Size then -- Só recalcula automaticamente se não foi definido tamanho manual
        local textSize = Title_1.TextBounds.X
        local iconSize = 0
        
        -- Se tiver ícone, adiciona espaço para ele
        if CloseUI.Icon and CloseUI.Icon ~= "" then
            iconSize = 21 -- 16 do ícone + 5 de padding
        end
        
        local totalWidth = textSize + iconSize + 40 -- 40 de padding extra
        local minWidth = 70 -- Largura mínima
        local maxWidth = 150 -- Largura máxima (opcional)
        
        totalWidth = math.clamp(totalWidth, minWidth, maxWidth)
        
        CloseUIShadow.Size = UDim2.new(0, totalWidth, 0, 40)
    end
end)
